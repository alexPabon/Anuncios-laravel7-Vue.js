<footer class="p-4 bg-light">
    <h4>Contacto: <small><a href="/contact-page">alepabon@gmail.com</a></small></h4>
    <h5>Enlaces de otros proyectos personales</h5>
    <div class="d-flex flex-wrap justify-content-sm-around justify-content-md-between justify-content-lg-start">
        <x-my-footer.page-link url="http://preguntas.alexpabon.es" imgUrl="/./storage/images/portales/preguntas.png" titleLink=""/>
